    ...
    <div class="container py-5">
      <div class="form-container">
        <div class="text-center mb-4">
          <h2 class="text-warning"><i class="bi bi-pencil-square me-2"></i>회원정보 수정</h2>
          <p class="text-muted">기존 회원 정보를 수정합니다</p>
        </div>
        <div class="search-section">
          <h5 class="mb-3"><i class="bi bi-search me-2"></i>수정할 회원 검색</h5>
          <div class="row">
            <div class="col-md-6">
        ...
        <!-- ...기타 member_edit.html의 나머지 폼 요소도 동일하게 옮겨서 경로만 ${root}로 변경하면 됩니다... -->
      </div>
    </div>
  </body>
</html>
